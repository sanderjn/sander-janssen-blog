<template>
    <nuxt-link :to="link.to" class="inline-flex items-center bg-primary-500 px-6 py-3 rounded-full font-mono text-sm font-medium text-white antialiased transition-colors hover:bg-primary-600">
